-- ROLLBACK for migration 0015 - restores the PROD state captured by
-- migrations/0015_tools/snapshot_state.py at 2026-09-19T14:47:38+00:00 (connected as postgres).
-- Generated from the LIVE database BEFORE 0015 was applied. Apply with the SAME environment only:
--     psql / any client on the PROD DATABASE_URL, run this file as one transaction.
-- STATE_FINGERPRINT=440a7b2e929c43db5822e3212ac577a528ebbd2d556cc00417c142268ec156c8
...
-- document_types: owner=postgres rls=False force_rls=False
...
-- lookup_values: owner=postgres rls=False force_rls=False
-- schema_migrations: owner=postgres rls=False force_rls=False
-- scholarships: owner=postgres rls=True force_rls=False
-- settings: owner=postgres rls=False force_rls=False
-- users: owner=postgres rls=False force_rls=False
