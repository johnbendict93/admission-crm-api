...
class Settings(BaseSettings):
    ...
    # convention as CONVERSION_MODEL_PATH / FOLLOWUP_TIMING_MODEL_PATH / DROPOUT_RISK_MODEL_PATH / FEE_DEFAULT_RISK_MODEL_PATH / CALL_SENTIMENT_MODEL_PATH above.
    DEMAND_FORECAST_MODEL_PATH: str = "ml/artifacts/demand_forecast_model.joblib"
    # convention as CONVERSION_MODEL_PATH / FOLLOWUP_TIMING_MODEL_PATH / DROPOUT_RISK_MODEL_PATH / FEE_DEFAULT_RISK_MODEL_PATH / CALL_SENTIMENT_MODEL_PATH / DEMAND_FORECAST_MODEL_PATH above.
    FRAUD_DETECTION_MODEL_PATH: str = "ml/artifacts/fraud_detection_model.joblib"
