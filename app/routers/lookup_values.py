...
@router.get("/", response_model=PaginatedResponse[LookupValueResponse])
def list_lookup_values(
    ...
    try:
        items, total = lookup_values_service.get_all_lookup_values(supabase, limit=limit, offset=offset)
